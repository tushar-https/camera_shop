                                ...
                                <asp:View ID="View1" runat="server">
                                    <table class="style1">
                                        ...
                                        <tr>
                                            <td align="center">
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <asp:Button ID="Button3" title="paynow" runat="server" CssClass="btn" onclick="Button3_Click" 
                                                    Text="PAY NOW" Height="30px" Width="80px" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="Button2" runat="server" CssClass="btn" Height="30px" 
                                                    onclick="Button2_Click" Text="PAY NOW" Width="113px" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:View>
